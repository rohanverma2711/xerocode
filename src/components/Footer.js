...
function Footer() {
  return (
    <footer class="bg-footerColor mb-20 mt-80 bg-opacity-10">
    <div class="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div>
          ...
          <p class="mt-6 max-w-md font-normal text-base text-center leading-relaxed text-gray-500 sm:max-w-xs sm:text-left">
        ...
        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
          <div class="text-center sm:text-left ">
            <p class="text-2xl font-semibold text-tileColortext">
              Our Links
            </p>

            <ul class="mt-8 space-y-4  text-base font-normal">
              <li>
                <a
                  class="text-middleLine transition hover:text-gray-700/75"
                  href="/"
                >
                  Home
                </a>
              ...
              <li>
                <a
                  class="font-semibold transition text-navButton hover:text-gray-700/75"
                  href="/"
                >
                  Integrations
                </a>
